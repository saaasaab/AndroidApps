...
public class Bluetooth {
    ...
    public void openBT() throws IOException
    {
        ...
        Toast toast = Toast.makeText(context, "Bluetooth connection opened", Toast.LENGTH_SHORT);
        toast.show();
    }

    public void beginListenForData()
    {
        Toast toast = Toast.makeText(context, "Listening for incoming Bluetooth data in background", Toast.LENGTH_SHORT);
        toast.show();
