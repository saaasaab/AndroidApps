...
public class RepCounter extends Activity {
    public int weight = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        weight = intentReceive.getIntExtra("Weight",0);
        ...
        btnRep31.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                createNewIntent(31,workout,sectionType,total);
            }
        });
        ...
        btnRep40.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
            createNewIntent(40,workout,sectionType,total);
            }
        });
    }
    private void messageDisplay(int reps){
        Toast.makeText(RepCounter.this, weight*reps + "lbs lifted", Toast.LENGTH_SHORT).show();
    }
